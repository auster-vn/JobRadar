...
def test_salary_data_readiness_passes_complete_temporal_dataset() -> None:
    rows = [
        _row(
            ...
            month=month,
            role="Backend Developer" if index < 100 else "Data Engineer",
            location="Ha Noi" if index < 100 else "Ho Chi Minh",
        )
    ...
    assert report["qualified_segments"] == 2
...
def test_salary_data_readiness_explains_incomplete_snapshot() -> None:
    ...
    assert requirements["underqualified_segments"]["passed"] is False
